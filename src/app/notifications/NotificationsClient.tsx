                    ...
                    {filtered.map((notif, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`flex items-start gap-4 p-4 rounded-2xl border transition-all ${notif.isRead
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-stone-300 mt-2">{formatDate(notif.createdAt)}</p>
                                </div>
                                {!notif.isRead && (
                                    <button
