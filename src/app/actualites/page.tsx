            ...
            >
              <div className="relative h-64 overflow-hidden bg-stone-100">
                <Image
                  ...
                  fill
                />
                <div className="absolute top-4 left-4 z-10 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold text-green-700 uppercase tracking-widest">
                  {article.category}
                </div>
              </div>
