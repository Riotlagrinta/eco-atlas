...
import { getAllProtectedAreas } from '@/lib/actions';
import { Trees, ArrowRight, Maximize } from 'lucide-react';
        ...
        {areas.map((area, index) => (
          ...
          >
            <div className="h-64 relative bg-stone-100">
              {area.imageUrl && <Image
                src={area.imageUrl || 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80'}
            ...
            <div className="p-8 flex-1 flex flex-col">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center text-green-600 font-bold bg-green-50 px-3 py-1 rounded-lg text-sm">
                  <Maximize className="h-4 w-4 mr-1" /> {area.areaKm2 || '??'} km²
                </div>
              </div>
